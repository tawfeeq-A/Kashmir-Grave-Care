...
*Notes:* ${formData.notes || 'None'}`;
  ...
  return (
    <>
      ...
      <div className="bg-background pt-28 pb-20 min-h-screen flex flex-col justify-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          {/* Form Container */}
          <div className="bg-background border border-border/80 shadow-md rounded-3xl p-6 md:p-10 relative overflow-hidden">
            {submitted ? (
              /* Success Screen */
              <div className="text-center py-10 space-y-6">
                ...
                <div className="pt-6">
                  <button
                    ...
                    className="inline-flex items-center px-6 py-2.5 text-sm font-semibold text-primary-foreground bg-primary hover:bg-primary/95 rounded-xl transition-all"
                  >
                  ...
                  <div className="space-y-6 animate-fadeIn">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {[
                        ...
                        <label
                          key={pkg.name}
                          className={`flex items-start p-4 rounded-2xl border cursor-pointer hover:border-primary/50 transition-colors ${
                  ...
                  <div className="space-y-5 animate-fadeIn">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-2 text-sm bg-background border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary resize-none"
                      />
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-6 animate-fadeIn">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      {[
                        ...
                        <label
                          key={freq.val}
                          className={`flex flex-col justify-between p-5 rounded-2xl border cursor-pointer hover:border-primary/50 transition-colors ${
                ...
                <div className="flex justify-between items-center pt-6 border-t border-border/40 mt-4">
                  {step > 1 ? (
                    <button
                      type="button"
                      onClick={prevStep}
                      className="inline-flex items-center px-4 py-2.5 text-sm font-semibold text-foreground bg-secondary hover:bg-secondary/80 rounded-xl transition-all"
                    >
                  ...
                  {step < 4 ? (
                    <button
                      type="button"
                      onClick={nextStep}
                      className="inline-flex items-center px-5 py-2.5 text-sm font-semibold text-primary-foreground bg-primary hover:bg-primary/95 rounded-xl transition-all shadow-xs ml-auto"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center px-6 py-2.5 text-sm font-bold text-primary-foreground bg-primary hover:bg-primary/95 rounded-xl transition-all shadow-md ml-auto disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
                        <>
