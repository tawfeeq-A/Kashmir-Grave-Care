...
python3 @.kiro/steering/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python3 @.kiro/steering/design-system/scripts/search-slides.py "traction slide" \
