---
name: banner-design
description: "Design banners for social media, ads, website heroes, and creative assets. Multiple art direction options with AI-generated visuals. Actions: design, create, generate banner. Platforms: Facebook, Twitter/X, LinkedIn, YouTube, Instagram, Google Display, website hero. Styles: minimalist, gradient, bold typography, photo-based, illustrated, geometric, retro, glassmorphism, 3D, neon, duotone, editorial, collage. Uses ui-ux-pro-max, frontend-design, ai-artist, ai-multimodal skills."
...
Design banners across social, ads, and web formats. Generates multiple art direction options per request with AI-powered visual elements. This skill handles banner design only. Does NOT handle video editing or full website design.
...
1. **Purpose** — social cover, ad banner, website hero, or creative asset?
...
2. **Generate visual elements** with `ai-artist` + `ai-multimodal` skills
   ...
   **Aspect ratios:** `1:1`, `16:9`, `9:16`, `3:4`, `4:3`, `2:3`, `3:2`, `3:1`
   Match to platform - e.g., Twitter header = `3:1` (exact ratio), Instagram story = `9:16`
...
- **Text ratio**: Keep text minimal for ads; excess image text acts as a quality and performance constraint on ad delivery rather than a strict threshold.
