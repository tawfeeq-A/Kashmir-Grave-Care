...
### Text-to-Image Ratio
- Ads: Keep text minimal; Meta frames excess image text as a quality and performance consideration (high-text ads may run with lower reach) rather than a strict 20% rule.
