...
- Body text (#111827) on white background: ~17.7:1 contrast ratio (exceeds WCAG AAA)
- Secondary text (#6B7280) on white: ~4.8:1 contrast ratio (exceeds WCAG AA)
- Primary brand color (#2563EB) on white: ~5.2:1 contrast ratio (exceeds WCAG AA)
- Individual component states require individual contrast and interaction testing to ensure accessibility compliance.
