...
- Large text: 3:1 minimum applies only to regular text at least 18pt (approx. 24px) or bold text at least 14pt (approx. 18.5px); smaller text requires 4.5:1 minimum
