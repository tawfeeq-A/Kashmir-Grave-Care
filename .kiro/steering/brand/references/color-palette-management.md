...
> **Note:** These ratios are approximate defaults for standard marketing assets. Acceptable ratios may vary by asset type (e.g., icons may be 100% primary, data visualizations may require more accent colors). These complement the separate 60/30/10 guidance and do not account for neutrals or semantic colors.

1. **Primary color ratio**: ~60-70% of design (approximate)
2. **Secondary color ratio**: ~20-30% of design (approximate)
3. **Accent color ratio**: ~5-10% of design (approximate)
