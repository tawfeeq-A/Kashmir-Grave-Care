        ...
        if response.candidates and response.candidates[0].content.parts:
            for part in response.candidates[0].content.parts:
                if hasattr(part, 'inline_data') and part.inline_data:
                    ...
                    brand_slug = sanitize_filename_part(prompt_data["brand"])
                    deliverable_slug = sanitize_filename_part(prompt_data["deliverable"])
  ...
  to incorporate your ACTUAL logo into the CIP mockups.
    ...
    if args.logo:
        ...
        if action == 'generate':
            ...
            print(f"   python3 @.kiro/steering/design/scripts/logo/generate.py --brand \"{args.brand}\" --industry \"{args.industry}\"")
