...
### Text-to-Image Ratio
- Ads: High text density (e.g. over 20% of the banner area) may result in ad network flags, reduced delivery performance, or higher costs depending on the ad platform. Strive to keep copy clear and concise.
