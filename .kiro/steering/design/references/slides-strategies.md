...
python3 .kiro/steering/design-system/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python3 @.kiro/steering/design-system/scripts/search-slides.py "series a funding" -d strategy --json
```
