...
node .kiro/steering/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node .kiro/steering/design-system/scripts/generate-tokens.cjs -c tokens.json
node .kiro/steering/design-system/scripts/validate-tokens.cjs -d src/
```
