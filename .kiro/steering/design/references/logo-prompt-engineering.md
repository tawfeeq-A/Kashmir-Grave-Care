...
flat colors, solid shades, geometric, abstract, dynamic, cutting-edge,
...
### Tech Startup
```
Modern tech company logo, abstract geometric mark, flat blue and purple, solid colors,
...
### Healthcare
```
Healthcare medical logo, clean professional design, privacy-conscious healthcare style (such as abstract shield or protective hands instead of generic crosses/hearts),
calming blue and teal colors, trustworthy appearance, caring feel,
simple scalable mark, healthcare-appropriate, conservative visual style
```
