...
5 formulas for persuasive slide copy.
...
python3 @.kiro/steering/design-system/scripts/search-slides.py "problem agitation" -d copy

# Get emotion-appropriate formula
python3 @.kiro/steering/design-system/scripts/search-slides.py "urgency cta" -d copy
```
